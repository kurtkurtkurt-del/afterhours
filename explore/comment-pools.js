...
const COMMENT_POOL = {
  ...
  "Konzert": [
    { kim: "lena_k", zaman: "Nov 2023", eski: true,
      ...
      cevaplar: [ { kim: "tobi", zaman: "Nov 2023", body: "Agreed. Seated until the encore, then nobody was seated." } ] },
    { kim: "marek", zaman: "Sept 2024", eski: true,
      ...
      cevaplar: [ { kim: "annu", zaman: "Sept 2024", body: "Confirmed. Stood at the back once, never again." } ] },
    ...
    { kim: "seraph", zaman: "4 days ago",
      ...
      cevaplar: [ { kim: "juli", zaman: "3 days ago", body: "Still going? I'd take one." },
                  { kim: "seraph", zaman: "2 days ago", body: "Gone — but people keep dropping them in here the week of." } ] },
    ...
    { kim: "pia.m", zaman: "6 h ago",
      ...
      cevaplar: [ { kim: "lena_k", zaman: "3 h ago", body: "It's real. Bring a voice you don't need tomorrow." } ] }
  ],
  ...
  "Festival": [
    { kim: "vito", zaman: "Aug 2023", eski: true,
      ...
      cevaplar: [ { kim: "roh", zaman: "Aug 2023", body: "Best accidental afterhours I've had." } ] },
    ...
    { kim: "ferro", zaman: "Sept 2024", eski: true,
      ...
      cevaplar: [ { kim: "milo_b", zaman: "Sept 2024", body: "Same. The queue for water is basically a dating app." } ] },
    { kim: "tess", zaman: "5 days ago",
      body: "Line-up dropped and the second stage is quietly the better one again.",
      cevaplar: [ { kim: "ferro", zaman: "4 days ago", body: "It's always the better one. That's the joke by now." } ] },
    { kim: "kaan", zaman: "2 days ago",
      ...
      cevaplar: [ { kim: "sanne", zaman: "yesterday", body: "It fits inside one walk home if you stay east. That's the whole point of it." } ] },
  ...
  "Rave": [
    { kim: "0x_nadja", zaman: "Oct 2023", eski: true,
      ...
      cevaplar: [ { kim: "stv", zaman: "Oct 2023", body: "One guy tried and the whole floor turned around. Never seen a phone go away that fast." } ] },
    ...
    { kim: "hallo_ben", zaman: "May 2025", eski: true,
      ...
      cevaplar: [ { kim: "0x_nadja", zaman: "May 2025", body: "We left at 9 in the morning into full daylight. Brutal, correct." } ] },
    { kim: "lu", zaman: "3 days ago",
      ...
      cevaplar: [ { kim: "trm", zaman: "3 days ago", body: "Also: they mean it about the phones now, not just on the poster." } ] },
    { kim: "esra_p", zaman: "yesterday",
      ...
      cevaplar: [ { kim: "mira", zaman: "20 h ago", body: "Unannounced on purpose. It was the better room last time too." } ] },
    { kim: "grau", zaman: "2 h ago",
      body: "Bringing someone to their first one. Any advice that isn't 'drink water'?",
      cevaplar: [ { kim: "hallo_ben", zaman: "1 h ago", body: "Agree on a meeting spot. Phones die, the room is dark, that's it." } ] }
  ],
  ...
  "Club Night": [
    { kim: "roza", zaman: "Dec 2023", eski: true,
      ...
      cevaplar: [ { kim: "n_than", zaman: "Dec 2023", body: "The Thursday version is the one people still talk about." } ] },
    ...
    { kim: "aylin", zaman: "Jan 2025", eski: true,
      ...
      cevaplar: [ { kim: "roza", zaman: "Jan 2025", body: "That's the booking policy, not luck." } ] },
    ...
    { kim: "meret", zaman: "2 days ago",
      ...
      cevaplar: [ { kim: "kiez", zaman: "yesterday", body: "Card at the bar, cash at the door. Annoying but consistent." } ] },
    { kim: "sol", zaman: "8 h ago",
      ...
      cevaplar: [ { kim: "aylin", zaman: "5 h ago", body: "The pillar is a legitimate meeting point at this place." } ] }
  ],
  ...
  "Meetup": [
    { kim: "hanna", zaman: "Oct 2023", eski: true,
      ...
      cevaplar: [ { kim: "org_jo", zaman: "Oct 2023", body: "Four people and one broken chair. We kept the chair." } ] },
    ...
    { kim: "bine", zaman: "Nov 2024", eski: true,
      ...
      cevaplar: [ { kim: "hanna", zaman: "Nov 2024", body: "The second half is undocumented and that's fine." } ] },
    { kim: "yusuf", zaman: "6 days ago",
      ...
      cevaplar: [ { kim: "org_jo", zaman: "5 days ago", body: "Turning up is enough. Bring something only if you want to show it." } ] },
    { kim: "clea", zaman: "yesterday",
      body: "German or English? Asking for the friend I'm dragging along who's three weeks into the city.",
      cevaplar: [ { kim: "pauli", zaman: "22 h ago", body: "Both, in the same sentence usually. Nobody minds." } ] },
  ...
  "Hausparty": [
    { kim: "wg_küche", zaman: "Mar 2024", eski: true,
      ...
      cevaplar: [ { kim: "flo", zaman: "Mar 2024", body: "Put the good speaker in the kitchen and stop fighting it." } ] },
    ...
    { kim: "juno_r", zaman: "Feb 2025", eski: true,
      ...
      cevaplar: [ { kim: "wg_küche", zaman: "Feb 2025", body: "That was Timo. He's invited forever now." } ] },
    { kim: "sibel", zaman: "5 days ago",
      ...
      cevaplar: [ { kim: "nemo", zaman: "4 days ago", body: "Day of, and it's the fourth floor. There is no lift. That's the ritual." } ] },
    { kim: "mo", zaman: "2 days ago",
      body: "Bringing two people who don't know anyone. Is that a lot or normal here?",
      cevaplar: [ { kim: "juno_r", zaman: "yesterday", body: "Normal. Two is fine, six is a different situation." } ] },
...
function YORUMLARI_GETIR(etkinlik) {
  const havuz = COMMENT_POOL[etkinlik.kind] || [];
